...
{
	HID_DESCRIPTOR_MOUSE(MOUSE_MIN_AXIS, MOUSE_MAX_AXIS, MOUSE_MIN_PHYS, MOUSE_MAX_PHYS, 3, MOUSE_ABS)
};
...
/** Product serial string. This is a Unicode string containing the product's details in human readable form,
 *  and is read out upon request by the host when the appropriate string ID is requested, listed in the Device
 *  Descriptor.
 */
#ifdef USB_SERIAL
const USB_Descriptor_String_t PROGMEM SerialString = USB_STRING_DESCRIPTOR(USB_SERIAL);
#endif
